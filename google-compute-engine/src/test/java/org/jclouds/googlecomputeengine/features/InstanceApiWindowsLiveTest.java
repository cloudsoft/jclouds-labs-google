...
public class InstanceApiWindowsLiveTest extends BaseGoogleComputeEngineApiLiveTest {
   ...
   protected GoogleComputeEngineApi create(Properties props, Iterable<Module> modules) {
      Injector injector = newBuilder().modules(ImmutableSet.<Module>builder().addAll(modules).add(new BouncyCastleCryptoModule()).build())
                                      .overrides(props).buildInjector();
      ...
      GoogleComputeEngineApi api = injector.getInstance(GoogleComputeEngineApi.class);
